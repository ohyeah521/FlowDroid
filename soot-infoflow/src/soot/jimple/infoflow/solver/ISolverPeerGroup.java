...
/**
 * A solver peer group contains solvers that operate on the same target and are
 * interconnected between each other. The solver peer group is responsible to
...
public interface ISolverPeerGroup {
	...
	/**
	 * Add a solver to this peer group and notify the solver that it joined this
	 * peer group
	 *
	 ...
	 */
	Set<IncomingRecord> incoming(Abstraction d1, SootMethod m);
	...
	void registerSymbolicActivationUnit(Abstraction d1, Abstraction d2, ConcolicUnit activationUnit);
